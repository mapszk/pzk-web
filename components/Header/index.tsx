            ...
            <div className={menu ? "menu-on" : "menu-off"}>
                ...
                <ul className="menu__list">
                    <li className="menu__list_item">
                        <Link href="/">
                            <a onClick={handleMenuOff} className="menu__link"><Title>Home</Title></a>
                        </Link>
                    </li>
                    <li className="menu__list_item">
                        <Link href="/projects">
                            <a onClick={handleMenuOff} className="menu__link"><Title>Projects</Title></a>
                        </Link>
                    </li>
                    <li className="menu__list_item">
                        <Link href="/contact">
                            <a onClick={handleMenuOff} className="menu__link"><Title>Contact</Title></a>
                        </Link>
                    </li>
                </ul>
            </div>
