        ...
        <>
            ...
            <div className="general">
                ...
                <section className="aboutme__section">
                    ...
                    <Para>
                        My name is Martin, I develop websites adapted to the
                        client needs, looking always for optimal performance,
                        and using design standards according to the product or
                        the service. I'm a self-taught person in constant
                        learning. Let's work together!
                    </Para>
                    <Title>Tools</Title>
